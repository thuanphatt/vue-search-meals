    ...
    <div class="mx-auto w-full container p-4 sm:p-3">
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          ...
          <a
            href="https://www.instagram.com/thuan.phatt/"
            class="text-black hover:text-gray-900"
          >
            <svg
              class="w-5 h-5"
          ...
          <a
            href="https://twitter.com/thuan_phatt"
            class="text-black hover:text-gray-900"
          >
            <svg
              class="w-5 h-5"
          ...
          <a
            href="https://github.com/thuanphatt"
            class="text-black hover:text-gray-900"
          >
            <svg
              class="w-5 h-5"
          ...
          <a href="#" class="text-black hover:text-gray-900"> </a>
        </div>
      </div>
    </div>
  </footer>
